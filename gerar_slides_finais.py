...
def make_das():
    ...
    three_cards(s,[("Prompts","Enunciado, geração, pesquisa e revisão final registrados.","blue"),("11 correções","Estrutura, interfaces, métricas, níveis, backup e autoria.","orange"),("Consolidação","Raphael coordenou a consolidação em 06/09; o Codex conferiu os artefatos e a divisão final foi registrada.","green")],1.65,3.5)
...
def make_cloud():
    ...
    s=S("Post-Mortem","IA como rascunho e objeto de auditoria");three_cards(s,[("Prompts","Enunciado, AWS, custo e revisão final registrados.","blue"),("10 correções","Ordem, repetição, taxonomia, custo, limites e autoria.","orange"),("Consolidação","Raphael coordenou a consolidação em 06/09; o Codex conferiu os artefatos e a divisão final foi registrada.","green")],1.65,3.5)
