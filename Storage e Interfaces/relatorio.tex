...
{\normalsize\itshape Atualização da Tabela 16.1 (Elmasri \& Navathe, 7\textsuperscript{a} ed.)\\ para o mercado de setembro de 2026}\\[0.6cm]
...
18,6$\times$ no 3\textsuperscript{o}. Terceiro, o desempenho de um
...
fabricante:} \emph{datasheets} e manuais de produto, complementados por preços de varejo
observados em setembro de 2026.
...
\subsection{Tabela 16.1 atualizada --- setembro de 2026}
...
kilobyte. Preços de varejo observados em setembro de 2026, durante a escassez de memória e
...
96\,MB--512\,MB &
$\approx$8,9\,ns$^{\ddagger}$ \newline (L1 0,70; L2 2,46) &
...
\item \textbf{Tempo de acesso do \emph{cache} ($\ddagger$) --- derivação, não
      ...
      Adotamos o \emph{boost} de 5,7\,GHz do 9950X3D2:
      $4/5{,}7 = 0{,}70$\,ns (L1), $14/5{,}7 = 2{,}46$\,ns (L2) e
      $46{,}5/5{,}7 = 8{,}16$\,ns (L3), com $+$4 ciclos ($+0{,}70$\,ns) para o V-Cache
      empilhado, totalizando $\approx$8{,}9\,ns. \textbf{Nenhum desses valores é
...
\item \textbf{\emph{Tape jukebox}.} Nem a IBM nem a Quantum publicam \emph{throughput}
      ...
      927\,PB é derivada de 23.170 cartuchos $\times$ 40\,TB. Preços de bibliotecas de fita
...
\item \textbf{Divergência entre rastreadores de preço.} Rastreadores automatizados de preço
      ...
      não um ponto.
\item \textbf{Os números do 9100 PRO são do modelo de 1\,TB}, que é o precificado na
      coluna de preço --- e não os de topo da família. O \emph{datasheet} Rev.~1.0 mostra
...
\begin{tabular}{@{}lrrrr@{}}
\toprule
\textbf{Trimestre} & \textbf{3T25} & \textbf{1T26} & \textbf{2T26} & \textbf{3T26} \\
\midrule
...
($\approx$US\$\,41/TB). \textbf{O valor corrente, no 3\textsuperscript{o} trimestre de 2026,
é 18,6$\times$}; os 16,3$\times$ referem-se ao trimestre anterior. Uma versão anterior deste
...
para US\$\,540 em setembro de 2026 --- alta de $\approx$575\%.\\[4pt]
...
SSD e HDD divergiram em custo & Razão de 18,6$\times$ por TB no 3T26 (era 7$\times$ no 3T25); invalida a premissa de convergência \\
\bottomrule
\end{tabular}
\end{center}
...
USB4 v2.0 & 2022 & Serial PAM3 & 80 (120 assim.)\,Gb/s & $\approx$9,6\,GB/s & $\approx$50\,\textmu s$^\ast$ & 1\,m ativo & Sim & Roteado & SSD externo NVMe \\
\midrule
...
NVMe/TCP & 2018 & \emph{Fabric} IP & 10--400\,GbE & $\approx$ Ethernet & \textbf{122--177\,\textmu s} (P99,99) & ilimitada (IP) & Sim & Rede IP roteável & Sucessor do iSCSI \\
...
FCoE (FC-BB-5) & 2009 & FC s/ Ethernet DCB & 10--40\,GbE & $\approx$ Ethernet & $\approx$ FC $+$ DCB & L2, não roteável & Sim & Ethernet convergente & \textbf{Obsoleto} \\
\midrule
...
Thunderbolt 5 & 2023 & Serial (USB4 v2) & 80 (120 \emph{boost})\,Gb/s & 64\,Gb/s de PCIe & $\approx$50\,\textmu s$^\ast$ & 1\,m passivo & Sim & \emph{Daisy-chain}, 6 & SSD externo profissional \\
...
clássico de SAN Ethernet. O NVMe/TCP roda em qualquer rede IP e é operacionalmente trivial,
ao preço de 80--150\,\textmu s adicionais e maior consumo de CPU. \textbf{Para a maioria dos
SBDs, NVMe/TCP é a escolha certa}; RoCE justifica-se apenas quando P99 abaixo de
...
seja, o número está certo e é o mais relevante; o que faltava era dizer que número ele é.} O iSCSI, por sua vez, foi tornado obsoleto pelo
NVMe/TCP: mesma facilidade, latência 2 a 4 vezes menor.
...
velocidade previsto}. O SAS permanece a interface majoritária de
\textbf{HDD} de capacidade e de \emph{backplanes} tri-modo, e apenas isso.
...
\textbf{FCoE} está morto na prática. A promessa era convergência (um cabo só), mas exigia
...
\textbf{Atenção à distinção}: FCoE morreu; \textbf{Fibre Channel nativo não} --- a
...
\textbf{síncrono, pequeno (8--16\,KB) e serializado}: o \emph{throughput} de transações por
\emph{thread} de \emph{log} é limitado, em primeira ordem, por $1/\text{latência do fsync}$.
...
1\textsuperscript{o} de 2026 e está em \textbf{18,6$\times$} no 3\textsuperscript{o}
trimestre de 2026. A premissa de que o SSD tornaria o
\emph{tiering} desnecessário não se realizou; ao contrário, o \emph{tiering} ficou mais
importante.

\textbf{Terceiro}, e mais relevante para a disciplina, \textbf{largura de banda deixou de
ser o parâmetro que importa}. O orçamento de latência da Seção~4.4 mostra que, em NVMe
...
\item USB-IF. \emph{USB4 Version 2.0 Specification} (80\,Gb/s), out./2022.
...
\item MICRON. \emph{9550 PRO NVMe SSD}; \emph{9650 Series} (primeiro SSD PCIe~6.0 em
      produção, fev./2026).
\item SAMSUNG. \emph{SSD 870 EVO Data Sheet}, Rev.~1.1; \emph{9100 PRO}; \emph{CMM-D MD220}
      (módulo de memória CXL).
...
\item IBM. \emph{TS4500 Tape Library}. QUANTUM. \emph{Scalar i6000}.
...
\textbf{18,6$\times$ no 3T26} --- o trimestre corrente. Acrescentada a tabela trimestral e o
